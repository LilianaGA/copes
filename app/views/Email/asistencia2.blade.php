					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						...
						<?php
							foreach ($detalle as $det) {
								echo "<br>";
								echo $det->Nombre_Alumno;
							}
						?>
						<br>
						<br> Por favor poner su cuenta al día a la mayor brevedad.
				        ...
				        <div class="col-md-6 col-md-offset-3">
				            <div class="testimonials">
				            	<div class="active item">
				                  <blockquote><p>Favor revisan y consultar los motivos de las ausencias</p></blockquote>
				                </div>
				            </div>
				        </div>
				    </div>
