                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @if(isset($materias))
                                @if(count($materias)>0) 
                                    @if(count($materias)>1) 
                                        <select id="select-materia" data-placeholder="Seleccione una Materia" class="chosen-select form-control multiselect multiselect-icon"  name="searchFamily">
                                            <option value="0"></option>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Edición de la rúbrica</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="ui-group-buttons">
                                <a class="btn btn-success" onclick="updateItemAlumno()" role="button" data-dismiss="modal"><span class="glyphicon glyphicon-ok"></span>&nbsp; Guardar</a>
...
{{HTML::script('js/profesor/rubros.js');}}
