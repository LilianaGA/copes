              ...
              <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="cedula" class="form-control" type="number" value="" placeholder="0123456789"  required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="apellido1" class="form-control" type="text"value="" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="apellido2" class="form-control" type="text" value="" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="seccion" class="form-control" type="text"value="" placeholder="2-2"  required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="nivel" class="form-control" type="text" value="" placeholder="Primaria" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="mensual" class="form-control" type="number" value="" placeholder="52500" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                     <div class="ui-group-buttons">
                        <button class="btn btn-success" id=""><span class="glyphicon glyphicon-ok"></span>&nbsp; Guardar</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="ui-group-buttons">
                                                ...
                                                <div class="or"></div>
                                                @if($usr->Estado == 'T')
                                                    <a href="{{'/Administrativo/'.$usr->id.'/deleteStudent' }}" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-unchecked"></span></a>
                                                @else
                                                    <a href="{{'/Administrativo/'.$usr->id.'/activeStudent' }}" class="btn btn-info" role="button"><span class="glyphicon glyphicon-check"></span></a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
